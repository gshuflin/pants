...
pub extern "C" fn scheduler_create(
  ...
  construct_single_file_snapshot: Function,
  ...
  type_single_file_snapshot: TypeId,
  type_binary_file_data: TypeId,
  ...
  let types = Types {
    ...
    construct_snapshot,
    construct_single_file_snapshot,
    ...
    single_file_snapshot: type_single_file_snapshot,
    binary_file_data: type_binary_file_data,
